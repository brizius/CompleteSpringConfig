...
public class SocialConfig extends SocialConfigurerAdapter {
  ...
  protected static final String PROPERTY_NAME_SECURITY_ENCRYPT_PASSWORD =
  ...
  public void addConnectionFactories(ConnectionFactoryConfigurer cfConfig, Environment env) {
    ...
    cfConfig.addConnectionFactory(new FivepxConnectionFactory(env.getProperty("fivepx.appKey"), env
        .getProperty("fivepx.appSecret")));
    cfConfig.addConnectionFactory(new FlickrConnectionFactory(env.getProperty("flickr.appKey"), env
        .getProperty("flickr.appSecret")));
  ...
  public UsersConnectionRepository getUsersConnectionRepository(
    ...
    UsersConnectionRepository repository =
        new JdbcUsersConnectionRepository(dataSource, connectionFactoryLocator,
            Encryptors.noOpText());
    // Encryptors.text(env.getProperty(PROPERTY_NAME_SECURITY_ENCRYPT_PASSWORD),
    // KeyGenerators.string().generateKey())); //random 8byte salt
    
    // Encryptors.queryableText(env.getProperty(PROPERTY_NAME_SECURITY_ENCRYPT_PASSWORD),
    // KeyGenerators.string().generateKey())); //random 8byte salt
    
    // Encryptors.queryableText(env.getProperty(PROPERTY_NAME_SECURITY_ENCRYPT_PASSWORD),
    // env.getProperty(PROPERTY_NAME_SECURITY_ENCRYPT_SALT)));
  ...
  public ConnectController connectController(ConnectionFactoryLocator connectionFactoryLocator,
    ...
    connectController.addInterceptor(new EnsureUniqueConnectInterceptor(usersConnectionRepository,
  ...
  public DisconnectController disconnectController(
      UsersConnectionRepository usersConnectionRepository, Environment environment) {
